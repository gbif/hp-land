...
var siteConfig = {
  ...
  occurrence: {
    ...
    excludedFilters: ['continent', 'country', 'depth', 'establishmentMeans', 'eventId', 'hostingOrganizationKey', 'identifiedById', 'occurrenceStatus', 'organismId', 'organismQuantity', 'protocol', 'publishingCountryCode', 'recordedById', 'relativeOrganismQuantity', 'sampleSizeUnit', 'sampleSizeValue', 'dwcaExtension', 'collectionKey', 'networkKey', 'verbatimScientificName', 'projectId'],
