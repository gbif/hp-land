...
[![Build Status](https://builds.gbif.org/job/hp-land/badge/icon)](https://builds.gbif.org/job/hp-land/lastBuild/console)
...
# GBIF Hosted Portal: hp-land

This Jekyll website, **[hp-land](https://land.hp.gbif.org/)**, makes use of a theme and biodiversity widgets developed by the GBIF network.
